...
**Status: 1.0.2.** Recall injection, turn capture, tools, configuration and CLI are
wired end to end, covered by 187 tests across Python 3.11–3.13 on Linux, macOS and
